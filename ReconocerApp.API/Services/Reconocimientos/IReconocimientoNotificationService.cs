...
{
    Task EnviarNotificacionCreacionAsync(Reconocimiento reconocimiento, string reconocedorNombre, string reconocidoNombre, string reconocedorEmail);
    ...
    Task EnviarNotificacionRechazoAsync(Reconocimiento reconocimiento, ReconocimientoReviewRequest reviewRequest, string reconocedorEmail, string reconocedorNombre, string reconocidoNombre);
}